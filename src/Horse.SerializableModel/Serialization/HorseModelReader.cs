...
{
    /// <summary>
    /// Default model reader for Horse libraries
    /// </summary>
    public class HorseModelReader : IModelReader
    {

        private static HorseModelReader _default;

        /// <summary>
        /// Default, singleton HorseModelReader class
        /// </summary>
        public static HorseModelReader Default
        {
            get
            {
                if (_default == null)
                    _default = new HorseModelReader();
